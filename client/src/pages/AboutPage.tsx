            ...
            <div className="flex justify-center items-center h-screen">
                <div className="bg-white shadow-md rounded-lg p-8 max-w-[800px]">
                    ...
                    <p className="text-lg mb-6">
                        Welcome to our app! Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod
                    ...
                    <p className="text-lg mb-6">
                        ...
                        <a
                            href="mailto:shubhamwagh2544@gmail.com"
                            className="text-purple-700 font-semibold ml-2 tracking-tighter hover:underline"
                        >
                            Shubham Here 👋
                        </a>
                    </p>
                    <Button variant="default" className="py-5 bg-purple-700" onClick={() => navigate('/')}>
                        Go To HomePage
                    </Button>
                </div>
            </div>
